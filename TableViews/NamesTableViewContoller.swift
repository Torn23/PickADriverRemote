//
//  NamesTableViewContoller.swift
//  TableViews
//
//  Created by Toren Swanson on 3/24/21.
//

import UIKit

class NamesTableViewContoller: UITableViewController {
    var names = ["John", "Avery", "Brady", "Kaylee", "Grace", "Tyler", "Sam", "Colby"]
